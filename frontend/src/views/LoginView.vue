...
const handleLogin = async () => {
  ...
  // If we got here via the dashboard route guard, `redirect` points back
  // at whatever page the person actually wanted — fall back to /dashboard
  // for a direct visit to /login.
